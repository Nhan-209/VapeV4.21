...
extends Mapping {
    ...
    private MClickType(int[] nArray) {
        ...
        if (nArray != null) {
            ...
            this.P = this.u(string2, bl2, clazz2);
            Class clazz3 = MappedClasses.V_;
            boolean bl3 = true;
            String string3 = "SWAP";
            MClickType mClickType3 = this;
            this.B = this.u(string3, bl3, clazz3);
        ...
        this.P = this.u(string8, bl8, clazz8);
