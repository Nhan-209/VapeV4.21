...
extends Mapping {
    ...
    private MSharedMonsterAttributes(int n) {
        ...
        if (ForgeVersion.MC_1_20_6.d()) {
            ...
            this.W = mSharedMonsterAttributes.u(string, bl, clazz);
            ...
            this.y = this.u(string3, bl3, clazz3);
            ...
            this.F = this.u(string6, bl6, clazz6);
            ...
            this.e = this.u(string10, bl10, clazz10);
        } else {
            Class clazz = MappedClasses.Fe;
            boolean bl = true;
            ...
            this.e = this.u(string11, bl11, clazz11);
        }
    }
