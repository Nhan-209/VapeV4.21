...
extends Mapping {
    ...
    private MGlStateManager(int n) {
        ...
        if (n2 != 0) {
            if (ForgeVersion.MC_1_21_6.d()) {
                ...
                mGlStateManager.x(string, bl, clazz, classArray);
            }
            Class[] classArray = new Class[]{Float.TYPE, Float.TYPE, Float.TYPE, Float.TYPE};
            Class<Void> clazz = Void.TYPE;
            ...
            this.U = this.x(string6, bl6, clazz6, classArray6);
            ...
            this.D = this.x(string7, bl7, clazz7, classArray7);
            ...
            this.V = this.x(string12, bl12, clazz12, classArray9);
            ...
            this.x = this.x(string13, bl13, clazz13, classArray10);
            ...
            this.j = this.x(string14, bl14, clazz14, classArray11);
        ...
        if (ForgeVersion.MC_1_21_6.d()) {
            ...
            MGlStateManager mGlStateManager = this;
            this.O = mGlStateManager.x(string, bl, clazz, classArray);
        }
        if (ForgeVersion.MC_1_21_10.d()) {
            ...
            MGlStateManager mGlStateManager = this;
            this.p = mGlStateManager.x(string, bl, clazz, classArray);
        }
        if (ForgeVersion.MC_1_17.d()) {
            ...
            MGlStateManager mGlStateManager = this;
            this.c = mGlStateManager.x(string, bl, clazz, classArray);
            ...
            if (ForgeVersion.MC_1_21_6.v()) {
                ...
                this.W = this.x(string21, bl21, clazz21, classArray18);
            }
        } else {
            ...
            MGlStateManager mGlStateManager = this;
            this.q = mGlStateManager.x(string, bl, clazz, classArray);
            ...
            this.w = this.x(string22, bl22, clazz22, classArray19);
            ...
            this.c = this.x(string23, bl23, clazz23, classArray20);
            ...
            this.T = this.x(string24, bl24, clazz24, classArray21);
            ...
            this.h = this.x(string25, bl25, clazz25, classArray22);
            ...
            this.B = this.x(string26, bl26, clazz26, classArray23);
            ...
            this.o = this.x(string27, bl27, clazz27, classArray24);
            ...
            this.a = this.x(string30, bl30, clazz30, classArray27);
        }
        if (ForgeVersion.MC_1_17.d()) {
            ...
            this.V = this.x(string37, bl37, clazz37, classArray31);
            ...
            this.x = this.x(string38, bl38, clazz38, classArray32);
            if (ForgeVersion.MC_1_21_10.v()) {
                ...
                this.J = this.x(string39, bl39, clazz39, classArray33);
            }
            ...
            this.j = this.x(string40, bl40, clazz40, classArray34);
            ...
            this.L = this.x(string41, bl41, clazz41, classArray35);
            ...
            this.d = this.x(string42, bl42, clazz42, classArray36);
            ...
            this.i = this.x(string43, bl43, clazz43, classArray37);
            ...
            this.I = this.x(string44, bl44, clazz44, classArray38);
            ...
            this.U = this.x(string45, bl45, clazz45, classArray39);
            ...
            this.D = this.x(string46, bl46, clazz46, classArray40);
            ...
            this.V = this.x(string51, bl51, clazz51, classArray42);
            ...
            this.x = this.x(string52, bl52, clazz52, classArray43);
            ...
            this.J = this.x(string53, bl53, clazz53, classArray44);
            ...
            this.j = this.x(string54, bl54, clazz54, classArray45);
        } else {
            ...
            MGlStateManager mGlStateManager = this;
            this.L = mGlStateManager.x(string, bl, clazz, classArray); 
            ...
            this.d = this.x(string55, bl55, clazz55, classArray46);
            ...
            this.i = this.x(string56, bl56, clazz56, classArray47);
            ...
            this.I = this.x(string57, bl57, clazz57, classArray48);
            ...
            this.U = this.x(string58, bl58, clazz58, classArray49);
            ...
            this.D = this.x(string59, bl59, clazz59, classArray50);
            ...
            this.V = this.x(string64, bl64, clazz64, classArray52);
            ...
            this.x = this.x(string65, bl65, clazz65, classArray53);
            ...
            this.j = this.x(string66, bl66, clazz66, classArray54);
    ...
    private void i(int n, int n2, int n3, int n4, int n5, int n6, int n7, int n8, IntBuffer intBuffer) {
        if (this.J != null) {
            this.J.c(null, n, n2, n3, n4, n5, n6, n7, n8, intBuffer);
        }
    }
    ...
    private void W(float f, float f2, float f3, float f4) {
        this.z.c(null, Float.valueOf(f), Float.valueOf(f2), Float.valueOf(f3), Float.valueOf(f4));
    }
    ...
    private int j() {
        return this.j.Z(null, new Object[0]);
    }
    ...
    private void g(float f, float f2, float f3, float f4) {
        ...
        this.E.c(null, Float.valueOf(f), Float.valueOf(f2), Float.valueOf(f3), Float.valueOf(f4));
    }
