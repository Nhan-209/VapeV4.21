...
extends Mapping {
    ...
    private MMatrix4fHandle(int[] nArray) {
        ...
        this.Z = this.W(clazz4, string3, bl3, clazz3, classArray4);
        ...
        this.J = this.W(clazz6, string4, bl4, clazz5, classArray5);
        if (nArray != null) {
    ...
    private Object C(Object object, float f, float f2) {
        return this.Z.L(object, Float.valueOf(f), Float.valueOf(f2));
    }
    ...
    private Object r(Object object, float f, float f2) {
        return this.J.L(object, Float.valueOf(f), Float.valueOf(f2));
    }
