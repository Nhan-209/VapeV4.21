...
extends Mapping {
    ...
    public MDataComponents() {
        ...
        if (ForgeVersion.MC_1_21_11.d()) {
            ...
            this.y = this.u(string18, bl18, clazz18);
        }
    }
