...
extends Mapping {
    ...
    private void W(int n, int n2, int n3, FloatBuffer floatBuffer) {
        if (!GuiRenderPrimitives.V()) {
            this.S.c(null, n, n3, floatBuffer);
        } else {
            this.S.c(null, n, n2, n3, floatBuffer);
        }
    }
    ...
    private MGL11(boolean bl) {
        ...
        if (bl) {
            ...
            MGL11 mGL11 = this;
            this.Q = mGL11.x(string, bl2, clazz, classArray);
            return;
        }
        if (!GuiRenderPrimitives.V()) {
            ...
            MGL11 mGL11 = this;
            this.j = mGL11.x(string, bl3, clazz, classArray);
            ...
            MGL11 mGL112 = this;
            this.S = this.x(string2, bl4, clazz2, classArray2);
            ...
            MGL11 mGL114 = this;
            this.Q = this.x(string4, bl6, clazz4, classArray4);
        } else {
            Class[] classArray = new Class[]{Integer.TYPE, IntBuffer.class};
            Class<Void> clazz = Void.TYPE;
            boolean bl7 = false;
            ...
            MGL11 mGL11 = this;
            this.j = mGL11.x(string, bl7, clazz, classArray); 
