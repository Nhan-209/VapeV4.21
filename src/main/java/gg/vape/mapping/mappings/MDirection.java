...
extends Mapping {
    ...
    public int z(Object object) {
        return this.O.Z(object, new Object[0]);
    }

    public Object w(double d, double d2, double d3) {
        return this.m.L(null, d, d2, d3);
    }
    ...
    public MDirection() {
        ...
        this.m = ((MappingMethodBuilder)((MappingMethodBuilder)((MappingMethodBuilder)this.u(string, clazz, classArray).H(true)).A(ForgeVersion.MC_1_21_4.n(), "getApproximateNearest")).i(ForgeVersion.MC_1_21_4.b(), Wrapper.G)).s();
        Class[] classArray2 = new Class[]{};
        Class clazz2 = MappedClasses.u9;
        String string2 = "getAxis";
        MDirection mDirection2 = this;
        this.Y = ((MappingMethodBuilder)((MappingMethodBuilder)this.u(string2, clazz2, classArray2).A(ForgeVersion.MC_1_20_6.b(), "func_176740_k")).i(ForgeVersion.MC_1_20_6.b(), Wrapper.G)).s();
        Class[] classArray3 = new Class[]{};
        Class clazz3 = MappedClasses.Vy;
        String string3 = "getAxisDirection";
        MDirection mDirection3 = this;
        this.G = ((MappingMethodBuilder)((MappingMethodBuilder)this.u(string3, clazz3, classArray3).A(ForgeVersion.MC_1_20_6.b(), "func_176743_c")).i(ForgeVersion.MC_1_20_6.b(), Wrapper.G)).s();
        if (BlockData.W() != null) {
        ...
        this.O = this.u(string7, clazz7, classArray7).s();
    }
}
