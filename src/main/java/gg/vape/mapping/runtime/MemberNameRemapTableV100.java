...
extends MemberNameRemapTable {
    ...
    protected void _T() {
        ...
        this.z(MappedClasses.uQ, "drawInBatch", "drawInBatch", true, Void.TYPE, String.class, Float.TYPE, Float.TYPE, Integer.TYPE, Boolean.TYPE, MappedClasses.ZA, MappedClasses.ZK, MappedClasses.Y8, Integer.TYPE, Integer.TYPE);
