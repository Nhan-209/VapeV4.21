...
extends PanelComponent {
    final ClickGuiMacrosSettingsPanel J2;

    ClickGuiMacrosSettingsControlPanel(ClickGuiMacrosSettingsPanel clickGuiMacrosSettingsPanel, double d, double d2) {
        super(d, d2);
        this.J2 = clickGuiMacrosSettingsPanel;
    }

    @Override
    public void g(GuiMouseEvent guiMouseEvent) {
        if (ClickGuiMacrosSettingsPanel.F(this.J2) == ClickGuiMacrosSettingsViewMode.FULL_SETTINGS) {
            ...
            if ((float)guiMouseEvent.getY() >= f2 && (float)guiMouseEvent.getY() <= f3 && (double)guiMouseEvent.getX() >= this.G$src$D$1b2f02a() && (double)guiMouseEvent.getX() <= this.G$src$D$1b2f02a() + this.A()) {
                ClickGuiMacrosSettingsPanel.H(this.J2);
            }
        }
    }
    ...
    public void H() {
        boolean bl;
        ClickGuiMacrosSettingsViewMode clickGuiMacrosSettingsViewMode = ClickGuiMacrosSettingsPanel.F(this.J2);
        ...
        if (bl) {
            ...
            GuiRenderPrimitives.B(f, f6, f3, f7, ClickGuiMacrosSettingsPanel.N$src$Ljava_awt_Color_$1qg5s8k(), 3.0f);
            ...
            Color color2 = bl3 ? ClickGuiMacrosSettingsPanel.u$src$Ljava_awt_Color_$burlbh() : ClickGuiMacrosSettingsPanel.H$src$Ljava_awt_Color_$vzgv0a();
            GuiRenderPrimitives.B(f, f5, f3, 18.0, color2, 3.0f);
            GuiRenderPrimitives.P(f, f5, f3, 18.0, ClickGuiMacrosSettingsPanel.N$src$Ljava_awt_Color_$1qg5s8k(), 3.0f, 0.75f, 1.0f);
            ...
            ImageRenderer.E(ClickGuiMacrosSettingsControlPanel.J.h, f12, f13, "newbind", f10, f10, false);
            if (clickGuiMacrosSettingsViewMode == ClickGuiMacrosSettingsViewMode.KEYBIND_INPUT) {
                ...
                string = ClickGuiMacrosSettingsPanel.M(this.J2).h();
                if (string == null || string.isEmpty()) {
                    string = "No bind";
                }
                color = ClickGuiMacrosSettingsControlPanel.J.A;
            }
            SmoothFontRenderer smoothFontRenderer2 = this.O(0.8);
            ...
            if (clickGuiMacrosSettingsViewMode == ClickGuiMacrosSettingsViewMode.FULL_SETTINGS) {
                ...
                ImageRenderer.E(ClickGuiMacrosSettingsControlPanel.J.h, f19, f20, "newedit", f17, f17, false);
            }
            return;
        }
        ...
        Color color = bl4 ? ClickGuiMacrosSettingsPanel.u$src$Ljava_awt_Color_$burlbh() : ClickGuiMacrosSettingsPanel.H$src$Ljava_awt_Color_$vzgv0a();
