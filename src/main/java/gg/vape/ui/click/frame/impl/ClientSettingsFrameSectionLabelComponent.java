...
extends InteractiveComponent {
    ...
    public void H() {
        float f = 6.88f;
        SmoothFontRenderer smoothFontRenderer = this.O(this.v);
        ...
        ImageRenderer.E(this.I, (float)this.G$src$D$1b2f02a() + (float)this.A() - 5.0f - 5.0f, (float)d4, cb, this.b, this.b, false);
