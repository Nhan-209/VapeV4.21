...
extends FrameHeaderComponent {
    ...
    private void A$src$V$18zygv7() {
        ...
        float f = (float)ImageRenderer.m(this.R) / 3.5f;
        float f2 = (float)ImageRenderer.j(this.R) / 3.5f;
        ...
        ImageRenderer.E(color, (float)d4, (float)d3, this.R, f, f2, false);
        this.I.G(this.w$src$Lgg_vape_ui_click_frame_Frame_$y4htd0().y$src$Z$1f55jvh() ? SettingsFrameHeaderComponent.J.f : SettingsFrameHeaderComponent.J.W.darker());
        this.I.K(this.G$src$D$1b2f02a() + this.A() - 20.0);
        this.I.S(this.n() + 1.0);
        this.I.Y(this.L());
        this.I.o(10.0);
        this.Q.G(this.w$src$Lgg_vape_ui_click_frame_Frame_$y4htd0() instanceof CollapsibleFrame && !((CollapsibleFrame)((Object)this.w$src$Lgg_vape_ui_click_frame_Frame_$y4htd0())).q() ? SettingsFrameHeaderComponent.J.f : null);
    ...
    public SettingsFrameHeaderComponent(Frame frame, String string, String string2) {
        ...
        this.R = string;
        this.i = string2;
        this.I.r(new SettingsFrameHeaderToggleClickListener(this));
        this.Q.r(new SettingsFrameHeaderCollapseClickListener(this, frame));
