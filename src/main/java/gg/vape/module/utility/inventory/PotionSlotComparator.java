...
implements Comparator<Slot> {
    ...
    public int compare(Slot first, Slot second) {
        return this.n(first, second);
    }
    final InventoryManager V;

    public int n(Slot slot, Slot slot2) {
        ...
        float f2 = (float)tileEntityEnderChest2.o$src$I$tnn4wh() * tileEntityEnderChest2.o();
