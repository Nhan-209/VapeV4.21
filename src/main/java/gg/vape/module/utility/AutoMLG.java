...
extends Mod {
    ...
    public final AutoMLGPlacementController placementController;
    ...
    public AutoMLG() {
        ...
        this.placementController = new AutoMLGPlacementController(this);
    ...
    public void onTick(EventPreTick event) {
        ...
        if (this.state == AutoMLGState.IDLE && !this.shouldActivate()) {
            return;
        }
        if (localPlayer.b$src$Z$fqlxe4() && (this.state == AutoMLGState.EQUIPPING_ITEM || this.state == AutoMLGState.AIMING)) {
            this.resetState();
            return;
        }
