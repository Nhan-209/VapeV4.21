...
extends SubModule<FastUseModule> {
    ...
    private void processPacket(EventPacketSend eventPacketSend) {
        ...
        long baseDelay = ((Double)((FastUseModule)this.getParent()).delay.getValue()).longValue();
    ...
    public FastUsePacketDelaySubModule(Mod parent, String name) {
        super(parent, name);
    ...
    public String getDetailedSuffix() {
        return "Dynamic " + ((FastUseModule)this.getParent()).delay.getDisplayValue() + "ms";
    }
