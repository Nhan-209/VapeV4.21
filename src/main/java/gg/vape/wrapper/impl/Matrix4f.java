...
extends Wrapper {
    ...
    public Matrix4f c(FloatBuffer floatBuffer) {
        if (ForgeVersion.MC_1_20_6.d()) {
            return new Matrix4f(MMatrix4f.P(Matrix4f.c.getMappings().qJ, floatBuffer));
        }
        MMatrix4f.d(Matrix4f.c.getMappings().qJ, this.I, floatBuffer);
        return null;
    }

    public void a(Matrix4f matrix4f) {
        MMatrix4f.l(Matrix4f.c.getMappings().qJ, this.I, matrix4f);
    }
    ...
    public Matrix4f K(float f, float f2, float f3) {
        return new Matrix4f(MMatrix4f.O(Matrix4f.c.getMappings().qJ, this.I, f, f2, f3));
    }
}
