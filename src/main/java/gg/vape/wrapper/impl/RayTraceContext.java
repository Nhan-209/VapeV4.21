...
extends Wrapper {
    public static RayTraceContext b(Vec3 vec3, Vec3 vec32, RayTraceContext$FluidMode rayTraceContext$FluidMode, RayTraceContext$BlockMode rayTraceContext$BlockMode, Entity entity) {
        Object object = MRayTraceContext.P(RayTraceContext.vapeInstance.getMappingsMapperCompat().Rs, vec3.getObject(), vec32.getObject(), rayTraceContext$FluidMode.getObject(), rayTraceContext$BlockMode.getObject(), entity.getObject());
