...
extends Wrapper {
    public static RayTraceContextFactory v(Vec3 vec3, Vec3 vec32, ChestType jg_22, ITooltipFlag bA, Entity entity) {
        return new RayTraceContextFactory(RayTraceContextFactory.c.getMappingsMapperCompat().DV.n(vec3.getObject(), vec32.getObject(), jg_22.getObject(), bA.getObject(), entity.getObject()));
    }
