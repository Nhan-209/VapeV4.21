...
extends C03PacketPlayer {
    public static CPacketPlayerPosition newInstance(double d, double d2, double d3, boolean bl) {
        if (ForgeVersion.MC_1_21_4.d()) {
            return new CPacketPlayerPosition(CPacketPlayerPosition.c.getMappingsMapperCompat().R5.R(d, d2, d3, bl, false));
        }
        return new CPacketPlayerPosition(MCPacketPlayer_Position.T(CPacketPlayerPosition.c.getMappingsMapperCompat().R5, d, d2, d3, bl));
    }
